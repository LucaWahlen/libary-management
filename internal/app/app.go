...
func NewService(repository repository.Repository, validation validation.Validation) Service {
...
func (s *Service) GetLendings(w http.ResponseWriter, r *http.Request) {
...
func (s *Service) GetLendingByID(w http.ResponseWriter, r *http.Request) {
...
func (s *Service) CreateLending(w http.ResponseWriter, r *http.Request) {
...
func (s *Service) UpdateLending(w http.ResponseWriter, r *http.Request) {
	id, err := extractID(r, "/lendings/")
	if err != nil {
		http.Error(w, "Invalid lending ID", http.StatusBadRequest)
		return
...
func (s *Service) DeleteLending(w http.ResponseWriter, r *http.Request) {
	id, err := extractID(r, "/lendings/")
	if err != nil {
		http.Error(w, "Invalid lending ID", http.StatusBadRequest)
		return
